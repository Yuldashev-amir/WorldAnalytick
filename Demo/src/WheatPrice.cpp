#include "WheatPrice.h"

WheatPrice::WheatPrice(QObject * parent) : QObject(parent)
{
...
void WheatPrice::loadingWheatPrice()
{
    QPointer<WheatPrice> guard(this);
...
QUrl WheatPrice::url() const
{
    return m_url;
}

void WheatPrice::setUrl(const QUrl &newUrl)
{
    if (m_url == newUrl)
        return;
    m_url = newUrl;
...
QString WheatPrice::NameProd() const
{
    return m_NameProd;
}

void WheatPrice::setNameProd(const QString &newNameProd)
{
...
QString WheatPrice::interval() const
{
    return m_interval;
}

void WheatPrice::setInterval(const QString &newInterval)
{
...
QString WheatPrice::unit() const
{
    return m_unit;
}

void WheatPrice::setUnit(const QString &newUnit)
{
    if (m_unit == newUnit)
        return;
    m_unit = newUnit;
...
QStringList WheatPrice::date() const
{
    return m_date;
}

void WheatPrice::setDate(const QStringList &newDate)
{
    if (m_date == newDate)
        return;
    m_date = newDate;
...
QStringList WheatPrice::price() const
{
    return m_price;
}

void WheatPrice::setPrice(const QStringList &newPrice)
{
    if (m_price == newPrice)
        return;
    m_price = newPrice;
