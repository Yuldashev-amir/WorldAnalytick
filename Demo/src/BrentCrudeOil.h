#ifndef BRENTCRUDEOIL_H
#define BRENTCRUDEOIL_H
...
class BrentCrudeOil : public QObject
{
    Q_OBJECT
    QML_ELEMENT
...
public:
    explicit BrentCrudeOil(QObject * parent = nullptr);
    Q_INVOKABLE void loadingBrentData();
...
private:
    ...
    QUrl m_url = QUrl("https://www.alphavantage.co/query?function=BRENT&interval=monthly&apikey=demo");
    QString m_NameProd;
    QString m_interval;
    QString m_unit;
    QStringList m_date;
