...
#include <QString>
#include <QStringList>
class WheatPrice : public QObject
{
    Q_OBJECT
    QML_ELEMENT
...
public:
    explicit WheatPrice(QObject * parent = nullptr);
    Q_INVOKABLE void loadingWheatPrice();
...
private:
    ...
    QUrl m_url = QUrl("https://www.alphavantage.co/query?function=WHEAT&interval=monthly&apikey=demo");
    QString m_NameProd;
    QString m_interval;
    QString m_unit;
    QStringList m_date;
