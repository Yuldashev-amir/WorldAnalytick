...
NaturelGas::NaturelGas(QObject * parent) : QObject(parent)
{
...
{
    QPointer<NaturelGas> guard(this);
...
QUrl NaturelGas::url() const
{
    return m_url;
}

void NaturelGas::setUrl(const QUrl &newUrl)
{
    if (m_url == newUrl)
        return;
    m_url = newUrl;
...
QString NaturelGas::NameProd() const
{
    return m_NameProd;
}

void NaturelGas::setNameProd(const QString &newNameProd)
{
...
QString NaturelGas::interval() const
{
    return m_interval;
}

void NaturelGas::setInterval(const QString &newInterval)
{
...
QString NaturelGas::unit() const
{
    return m_unit;
}

void NaturelGas::setUnit(const QString &newUnit)
{
    if (m_unit == newUnit)
        return;
    m_unit = newUnit;
...
QStringList NaturelGas::date() const
{
    return m_date;
}

void NaturelGas::setDate(const QStringList &newDate)
{
    if (m_date == newDate)
        return;
    m_date = newDate;
...
QStringList NaturelGas::price() const
{
    return m_price;
}

void NaturelGas::setPrice(const QStringList &newPrice)
{
    if (m_price == newPrice)
        return;
    m_price = newPrice;
